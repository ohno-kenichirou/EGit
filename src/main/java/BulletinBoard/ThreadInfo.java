...
public class ThreadInfo implements Comparable<ThreadInfo>{
	...
	public ThreadInfo(int threadId, String title, String category, String createUserName, String createDate, String comment) {
	...
	public int compareTo(ThreadInfo t) {
		return Integer.compare(Integer.parseInt(t.getCreateDate()), Integer.parseInt(this.getCreateDate()));
